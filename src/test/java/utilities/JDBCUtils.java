...
public class JDBCUtils {
    ...
    // runSQLQuery(String query) -> it will return list of maps
    // closeDataBase
    // countRows(String query) --> it will return int
    ...
    //This method is doing a connection with Oracle SQL Database
